...
async def main():
    ...
    ua = "Mozilla/5.0 (Linux; U; Android 4.0.3; zh-cn; M031 Build/IML74K) UC AppleWebKit/534.31 (KHTML, like Gecko) Mobile Safari/534.31"
    ...
    time.sleep(100)
    # 在搜索框中输入python
    await page.type('input#index-kw', 'python')
    # 点击搜索按钮
    await page.click('input#index-su')
